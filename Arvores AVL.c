...
void rotacaoDireita(tipoNoh **raiz){
	...
	nohAuxiliar->altura = maior (alturaNoh(nohAuxiliar->esquerda), (*raiz)->altura)+1;
     printf("O noh %d fez uma rotacao simples a direita\n", (*raiz)->item.valor);
	*raiz = nohAuxiliar;
}
...
void rotacaoEsquerda(tipoNoh **raiz){
	...
	(*raiz)->altura = maior(alturaNoh((*raiz)->esquerda), alturaNoh((*raiz)->direita))+1;
	nohAuxiliar->altura = maior (alturaNoh(nohAuxiliar->esquerda), (*raiz)->altura)+1;
    printf("O noh %d fez uma rotacao simples a esquerda\n", (*raiz)->item.valor);
	*raiz = nohAuxiliar;
}

void rotacaoEsquerdaDireita(tipoNoh **raiz){
    printf("O Noh %d fez uma rotação dupla a esquerda e direita\n", (*raiz)->item.valor);
...
void rotacaoDireitaEsquerda(tipoNoh **raiz){
    ...
    printf("O Noh %d  fez uma rotação dupla a direita e esquerda\n", (*raiz)->item.valor);
